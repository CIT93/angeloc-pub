...
const savestatusToday = (statusToday) => {
...
console.log(`You have ${currentTime} time to eat before ${TimeToEatBefore} work`)
//new array
...
dailytask.forEach((dailytask, index) => {
const num = index + 1
...
//render
const renderStatusToday =(statusToday, filters) => {
...
document.querySelector("#new-statustodo").addEventListener("submit", () => {
  e.preventDefault()
  statusToday.push({
